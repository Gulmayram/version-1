      ...
      <div className="about-grid">
        ...
        <div className="about-card main-content">
          ...
          <div className="about-text-content">
            <p>Государственное предприятие <strong>"Кыргызгеология"</strong> является ведущей геологической организацией Кыргызской Республики, осуществляющей геологическое изучение недр, поиск и разведку месторождений полезных ископаемых.</p>
            <p>Наше предприятие обеспечивает устойчивое развитие минерально-сырьевой базы страны, привлечение инвестиций в геологоразведочную отрасль и развитие международного сотрудничества.</p>
          </div>
